        ...
        >
            <Form action='/public' className='flex-grow-1 d-flex flex-column' onSubmit={handleSubmit(onSubmit)}>
                ...
                <ModalBody className='flex-grow-1 pb-sm-0 pb-3 modal-body'>
                    ...
                    <FormGroup>
                        <Label className='form-label' for='startPrice'>
                            {trans('user.startPrice')}
                        </Label>
                        <Controller
                            as={Input}
                            control={control}
                            ...
                            defaultValue={_.get(props, 'data.startPrice') ?? ''}
                            className={classnames({ 'is-invalid': errors['startPrice'] || _.get(valErrors, 'startPrice') })}
                        />
                        <ErrorMessages valErrors={valErrors} errors={errors} name={'startPrice'} />
                    </FormGroup>
