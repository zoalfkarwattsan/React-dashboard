		...
		<div className={'row justify-content-center align-items-center'}>
			<div className={'col-sm-12 col-lg-6'}>
				<div className="container p-3">
					<div className="tab-content translations-content-item en visible p-2" id="en" style={{backgroundColor:'white', borderRadius:5}}>
						...
						<ul>
							<li>By email: info@arabunificationparty.com</li>
						</ul>
					</div>
				</div>
			</div>
